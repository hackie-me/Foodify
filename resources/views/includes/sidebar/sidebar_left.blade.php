    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
        ...
        <li class="menu-item">
            ...
            <ul id="customer" class="collapse" aria-labelledby="customer" data-parent="#side-nav-accordion">
                <li><a href="{{url("customer-review")}}">Customers Review</a>
                </li>
                <li><a href="{{url("customer-list")}}">Customers List</a>
                </li>
                <li><a href="{{url("social-activity")}}">Social Activity</a>
                </li>
            </ul>
        </li>
        <!-- Customers  end -->
        ...
        <li class="menu-item">
            ...
            <ul id="apps" class="collapse" aria-labelledby="apps" data-parent="#side-nav-accordion">
                ...
                <li><a href="{{url("app-to-do-list")}}">To-do List</a>
                </li>
            </ul>
        </li>
        <!-- /Apps -->
